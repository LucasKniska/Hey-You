...
class AwaitingResponse extends StatefulWidget {
  ...
  @override
  State<AwaitingResponse> createState() => _awaitingResponse();
}

class _awaitingResponse extends State<AwaitingResponse> {
  List<String> names = ['Lucas Kniska'];
        ...
        children: [
          ...
          Expanded(
              ...
              child: Align(
                ...
                child: Text("86% Match", style: TextStyle(fontSize: 24)),
